 ...
 * 
 * [NEED_OPENAUTHENTICATIONSUCCESS_OPENAUTHENTICATIONFAILURE_PROXYSUCCESS_WS,WS] -> [NEED_OPENAUTHENTICATIONSUCCESS_OPENAUTHENTICATIONFAILURE_PROXYSUCCESS_WS, NULL]
 * [NEED_OPENAUTHENTICATIONSUCCESS_OPENAUTHENTICATIONFAILURE_PROXYSUCCESS_WS,OPENAUTHENTICATIONSUCCESS] -> [NEED_OPENUSER_WS,NULL]
 * [NEED_OPENAUTHENTICATIONSUCCESS_OPENAUTHENTICATIONFAILURE_PROXYSUCCESS_WS,OPENAUTHENTICATIONFAILURE] -> [NEED_FAILUREMESSAGE,setcode(code)]
 * [NEED_OPENAUTHENTICATIONSUCCESS_OPENAUTHENTICATIONFAILURE_PROXYSUCCESS_WS,PROXYSUCCESS] -> [NEED_OPENPROXYTICKET_SW,NULL]
 * 
